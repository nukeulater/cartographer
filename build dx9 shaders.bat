...
:compile_shader
	SETLOCAL ENABLEDELAYEDEXPANSION
		...
		.\bin\fxc.exe /O3 /T %~1 %~3 /Fo ./src/Blam/rasterizer/dx9/shaders/compiled/%~2_%~1.pso ./src/Blam/rasterizer/dx9/shaders/%~2.fx
    ENDLOCAL
EXIT /B 0
...
:replace_content
	SETLOCAL ENABLEDELAYEDEXPANSION
		...
		.\bin\w64devkit\bin\sed.exe -i "s/unsigned char __src_Blam_Engine_rasterizer_dx9_shaders_compiled_/static const unsigned char k_/g" %~2
...
:add_shader_bytecode_to_file
	SETLOCAL ENABLEDELAYEDEXPANSION
		...
		.\bin\w64devkit\bin\xxd.exe -i ./src/Blam/rasterizer/dx9/shaders/compiled/%~2_%~1.pso >> %~3 
...
:add_shader
	SETLOCAL ENABLEDELAYEDEXPANSION
		...
		set file="./src/Blam/rasterizer/dx9/shaders/compiled/%~1.h"
...
:cleanup
	SETLOCAL ENABLEDELAYEDEXPANSION
		del src\Blam\rasterizer\dx9\shaders\compiled\*.pso
    ENDLOCAL
EXIT /B 0

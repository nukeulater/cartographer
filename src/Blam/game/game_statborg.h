...
enum e_statborg_entry : int32
{
	...
	_statborg_entry_custom_1,
	k_statborg_entry_total_stat_count
};
...
struct s_game_statborg_team_stats
{
	int16 statistic[k_statborg_entry_total_stat_count];
};
ASSERT_STRUCT_SIZE(s_game_statborg_team_stats, 18);
...
class c_game_statborg
{
	...
	s_game_statborg_team_stats m_team_data[k_multiplayer_team_count];

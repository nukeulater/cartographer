...
{
    float4 temp = (float4)(dot(_NORMAL.xyz, r10.xyz));
    	r10.w=temp.w;
}
{
    float4 temp = (float4)(max(c[15].yyyy  , r10.wwww ));
    	r10.w=temp.w;
}
...
{
    float4 temp = (float4)(c[203] * r11.wwww );
    	r11.x=temp.x;
    	r11.y=temp.y;
    	r11.z=temp.z;
    	r11.w=temp.w;
...
{
    float4 temp = (float4)((c[202] * r10.wwww ) + r11 );
    	oD0.x=temp.x;
    	oD0.y=temp.y;
    	oD0.z=temp.z;
    	oD0.w=temp.w;

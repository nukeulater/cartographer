...
{
    float4 temp = (float4)(_TANGENT.xxxx );
    	oT1.x=temp.x;
}
{
    float4 temp = (float4)(_BINORMAL.xxxx );
    	oT1.y=temp.y;
}
{
    float4 temp = (float4)(_NORMAL.xxxx );
    	oT1.z=temp.z;
}
{
    float4 temp = (float4)(_TANGENT.yyyy );
    	oT2.x=temp.x;
}
{
    float4 temp = (float4)(_BINORMAL.yyyy );
    	oT2.y=temp.y;
}
{
    float4 temp = (float4)(_NORMAL.yyyy );
    	oT2.z=temp.z;
}
{
    float4 temp = (float4)(_TANGENT.zzzz );
    	oT3.x=temp.x;
}
{
    float4 temp = (float4)(_BINORMAL.zzzz );
    	oT3.y=temp.y;
}
{
    float4 temp = (float4)(_NORMAL.zzzz );
    	oT3.z=temp.z;
}

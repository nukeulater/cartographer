...
#define C_ALT_BUMP_MAP_SCALE		c[18 + 3].xyyy
#define C_ALT_BUMP_MAP_TRANSLATE	c[18 + 3].zwww
...
{
    float4 temp = (float4)(r9 * c[18 + 2].xyyy );
    	oT2.x=temp.x;
    	oT2.y=temp.y;
}
{
    float4 temp = (float4)(r9 * c[18 + 2].zwww );
    	oT3.x=temp.x;
    	oT3.y=temp.y;
}
...
{
    float4 temp = (float4)(dp3(r5 , _TANGENT ));
    	oT4.x=temp.x;
}
{
    float4 temp = (float4)(dp3(r5 , _BINORMAL ));
    	oT4.y=temp.y;
}
{
    float4 temp = (float4)(dp3(r5 , _NORMAL ));
    	oT4.z=temp.z;
}


{
    float4 temp = (float4)((r9 * C_ALT_BUMP_MAP_SCALE ) + C_ALT_BUMP_MAP_TRANSLATE );
    	oT5.x=temp.x;
    	oT5.y=temp.y;
}
...
{
    float4 temp = (float4)(dp3(-c[18 + 8] , _TANGENT ));
    	oT6.x=temp.x;
}
{
    float4 temp = (float4)(dp3(-c[18 + 8] , _BINORMAL ));
    	oT6.y=temp.y;
}
{
...
{
    float4 temp = (float4)(dp3(-c[18 + 9] , _TANGENT ));
    	r10.x=temp.x;
}
{
    float4 temp = (float4)(dp3(-c[18 + 9] , _BINORMAL ));
    	r10.y=temp.y;
}
{

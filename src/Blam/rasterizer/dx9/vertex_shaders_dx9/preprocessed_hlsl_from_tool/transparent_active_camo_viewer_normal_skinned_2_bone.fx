...
}
{
	...
	r4  = va_node_weights.yyyy * c[a0.x + 50] ;
 	r5  = va_node_weights.yyyy * c[a0.x + 51] ;
 	r6  = va_node_weights.yyyy * c[a0.x + 52] ;
 {
    float4 temp = (float4)(r0.xxxx );
    	a0.x=temp.x;
}
{
    float4 temp = (float4)(-va_node_weights.yyyy + c[4].wwww  );
    	r9.x=temp.x;
}
...
{
    float4 temp = (float4)(dot(c[4] .xyz, _NORMAL.xyz));
    	r5.x=temp.x;
}
{
    float4 temp = (float4)(dot(c[5] .xyz, _NORMAL.xyz));
    	r5.y=temp.y;
}
{
    float4 temp = (float4)(dot(c[6] .xyz, _NORMAL.xyz));
...
{
    float4 temp = (float4)(r5 );
    	oT3.x=temp.x;
    	oT3.y=temp.y;
    	oT3.z=temp.z;
}
{
    float4 temp = (float4)(max(r5.zzzz , c[15].yyyy  ));
    	r5.z=temp.z;
}
{
    float4 temp = (float4)(log2(r5.zzzz ));
        r4.x=temp.x;
}
{
    float4 temp = (float4)(r4.xxxx * c[18 + 9].xyyy );
    	r4.x=temp.x;
    	r4.y=temp.y;
}
{
    float4 temp = (float4)(pow(2.0f, r4.xxxx ));
    	r4.x=temp.x;
}
{
    float4 temp = (float4)(r4.xxxx * c[18 + 8].xxxx );
    	r5.z=temp.z;
    	r5.w=temp.w;
}
{
    float4 temp = (float4)(pow(2.0f, r4.yyyy ));
    	r4.x=temp.x;
}
{
    float4 temp = (float4)(r5 * r4.xxxx );
    	r5.x=temp.x;
    	r5.y=temp.y;
}
{
    float4 temp = (float4)((r5.xyyy * c[18 + 8].yyyy ) + c[18 + 8].zwww );
    	r5.x=temp.x;
    	r5.y=temp.y;
}
{
    float4 temp = (float4)(r5 * c[18 + 9].zzzz );
    	r5.x=temp.x;
    	r5.y=temp.y;
    	r5.z=temp.z;
    	r5.w=temp.w;
...
{
    float4 temp = (float4)(1.0f / (oPos.wwww ));
        r4.w=temp.w;
}

{
    float4 temp = (float4)(oPos.xxxx * r4.wwww );
    	r10.w=temp.w;
}
{
    float4 temp = (float4)(oPos.yyyy * r4.wwww );
    	r11.w=temp.w;
}


{
    float4 temp = (float4)((r10.wwww * c[5].wwww  ) + c[5].wwww  );
    	r10.w=temp.w;
}
{
    float4 temp = (float4)((-r11.wwww * c[5].wwww  ) + c[5].wwww  );
    	r11.w=temp.w;
}
...
{
    float4 temp = (float4)(c[4]  * r5.zzzz );
    	r10.x=temp.x;
    	r10.y=temp.y;
    	r10.z=temp.z;
}
{
    float4 temp = (float4)(c[5]  * r5.wwww );
    	r11.x=temp.x;
    	r11.y=temp.y;
    	r11.z=temp.z;
}
...
{
    float4 temp = (float4)(r10.wwww + r5.xxxx );
    	oT1.z=temp.z;
}
...
{
    float4 temp = (float4)(r11.wwww + r5.yyyy );
    	oT2.z=temp.z;
}
...
{
    float4 temp = (float4)(dot(-r5.xyz, c[6] .xyz));
    	r5.w=temp.w;
}
	oFog = (r5.wwww * c[18 + 5].xxxx ) + c[18 + 5].yyyy ;
 {
    float4 temp = (float4)((r5.wwww * c[18 + 5].xxxx ) + c[18 + 5].yyyy );
    	oT0.z=temp.z;
}

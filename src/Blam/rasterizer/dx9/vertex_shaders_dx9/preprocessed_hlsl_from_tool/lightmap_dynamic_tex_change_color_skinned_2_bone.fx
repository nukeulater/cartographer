...
{
    float4 temp = (float4)(max(c[15].yyyy  , r5.wwww ));
    	r10.w=temp.w;
}
{
    float4 temp = (float4)(c[205] * r10.wwww );
    	r10.x=temp.x;
    	r10.y=temp.y;
    	r10.z=temp.z;
}
{
    float4 temp = (float4)(c[4].wwww  + -r10.wwww );
    	r10.w=temp.w;
}
{
    float4 temp = (float4)((c[206] * r10.wwww ) + r10 );
    	r10.x=temp.x;
    	r10.y=temp.y;
    	r10.z=temp.z;
}
{
    float4 temp = (float4)(c[207] * r10 );
    	oD1.x=temp.x;
    	oD1.y=temp.y;
    	oD1.z=temp.z;
}
...
{
    float4 temp = (float4)(r11.xxxx * c[7].wwww  );
    	oD0.w=temp.w;
}


{
    float4 temp = (float4)(dot(-c[18 + 8].xyz, r5.xyz));
    	r11.w=temp.w;
}
{
    float4 temp = (float4)(r11.xxxx * r5.wwww );
    	r10.w=temp.w;
}
{
    float4 temp = (float4)((r10.wwww * c[6].wwww  ) + -r11.wwww );
    	oD1.w=temp.w;
}

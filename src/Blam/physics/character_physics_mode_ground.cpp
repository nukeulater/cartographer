...
{
	static const real32 k_edge_drop_value = 0.117f * 30.f;

	__asm
	{
		sub esp, 4
		call game_tick_length
		fstp [esp]
		movss xmm2, [esp]
		mulss xmm2, [k_edge_drop_value]
		add esp, 4
		ret
	}
}
...
static void __stdcall c_character_physics_mode_ground_datum__update_internal(
	class c_character_physics_mode_ground_datum* thisx,
	struct s_character_physics_update_output_datum* physics_output,
	const struct s_character_physics_update_input_datum* physics_input,
	bool localize_airborne,

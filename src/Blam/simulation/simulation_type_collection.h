...
enum
{
	...
	k_simulation_event_type_maximum_count = 32,

	k_simulation_entity_maximum_update_flag_count = 32,
	k_simulation_entity_maximum_creation_data_size = 128,
	k_simulation_entity_maximum_state_data_size = 1024,
...
public:
	...
	int32 get_event_definition_count(void) const;

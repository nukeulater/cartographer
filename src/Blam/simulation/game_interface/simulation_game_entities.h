...
public:
	...
	virtual uint32 state_data_size(void) const = 0;
	virtual uint32 creation_data_size(void) const = 0;
	...
	virtual void entity_creation_encode(uint32 creation_data_size, void* creation_data, void* telemetry_data, class c_bitstream* packet) = 0;
	virtual bool entity_creation_decode(uint32 creation_data_size, void* creation_data, class c_bitstream* packet) = 0;
	virtual bool entity_update_encode(bool a1, uint32 update_mask, uint32* update_mask_written, uint32 state_data_size, void* state_data, void* telemetry_data, class c_bitstream* packet, int32 required_leave_space_bits) = 0;

...
#include "..\include\IStreamPlayer.h"
...
class CStreamPlayer: public IStreamPlayer
{
	...
	std::chrono::time_point<std::chrono::system_clock> lastSourcePlayTime;
	...
	bool disableSpatial = true;

	long long _identifier = 0; // GFWL xuid
public:
	CStreamPlayer(long long identifier);
	~CStreamPlayer();
	...
	long long GetPlayerIndentifier() override;

...
{
    float4 temp = (float4)(dot(_POSITION.xyzw, c[0].xyzw));
    	r10.x=temp.x;
}
{
    float4 temp = (float4)(dot(_POSITION.xyzw, c[1].xyzw));
    	r10.y=temp.y;
}
{
    float4 temp = (float4)(dot(_POSITION.xyzw, c[2].xyzw));
    	r10.z=temp.z;
}
{
    float4 temp = (float4)(dot(_POSITION.xyzw, c[3].xyzw));
    	r10.w=temp.w;
}
...
{
    float4 temp = (float4)(r10.wwww * c[5].wwww  );
    	r11.w=temp.w;
}
{
    float4 temp = (float4)((r10.xxxx * c[5].wwww  ) + r11.wwww );
    	oT2.x=temp.x;
}
{
    float4 temp = (float4)((-r10.yyyy * c[5].wwww  ) + r11.wwww );
    	oT2.y=temp.y;
}
{
    float4 temp = (float4)(r10.zwww );
    	oT2.z=temp.z;
    	oT2.w=temp.w;
}
...
{
    float4 temp = (float4)(r10.zzzz * r10.wwww );
    	r10.y=temp.y;
}
{
    float4 temp = (float4)(c[18 + 4].wwww );
    	r10.x=temp.x;
    	r10.w=temp.w;
}
...
{
    float4 temp = (float4)(dot(va_normal.xyz, r5.xyz));
    	r10.w=temp.w;
}
{
    float4 temp = (float4)(va_normal * r10.wwww );
    	r10.x=temp.x;
    	r10.y=temp.y;
    	r10.z=temp.z;
}
...
{
    float4 temp = (float4)((float)(pow(r10.yyyy , power)));
    			dest.z=temp.z;
}
		}
	}

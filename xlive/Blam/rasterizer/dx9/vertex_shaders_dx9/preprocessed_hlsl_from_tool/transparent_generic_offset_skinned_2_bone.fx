...
{
    float4 temp = (float4)((r10 * c[18 + 8].wwww ) + _POSITION );
    	r10.x=temp.x;
    	r10.y=temp.y;
    	r10.z=temp.z;
}
...
{
	float temptemp;
	temptemp = dot(_POSITION2.xyz, c[18 + 0].xyz);
...
{
	float temptemp;
	temptemp = dot(_POSITION2.xyz, c[18 + 1].xyz);
...
{
	float temptemp;
	temptemp = dot(_POSITION2.xyz, c[18 + 2].xyz);
...
{
	float temptemp;
	temptemp = dot(_POSITION2.xyz, c[18 + 3].xyz);
...
{
	float temptemp;
	temptemp = dot(_POSITION2.xyz, c[18 + 4].xyz);
...
{
	float temptemp;
	temptemp = dot(_POSITION2.xyz, c[18 + 5].xyz);

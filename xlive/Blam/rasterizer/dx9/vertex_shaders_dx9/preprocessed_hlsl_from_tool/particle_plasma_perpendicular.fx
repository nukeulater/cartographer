...
{
    float4 temp = (float4)((r10.xyyy * c[18 + 0].xyyy ) + c[18 + 0].zwww );
    	oT0.x=temp.x;
    	oT0.y=temp.y;
}
{
    float4 temp = (float4)((r10.xyyy * c[18 + 1].xyyy  ) + c[18 + 1].zwww );
    	oT1.x=temp.x;
    	oT1.y=temp.y;
}
{
    float4 temp = (float4)((r10.xyyy * c[18 + 2].xyyy  ) + c[18 + 2].zwww );
    	oT2.x=temp.x;
    	oT2.y=temp.y;
}
{
    float4 temp = (float4)((r10.xyyy * c[18 + 3].xyyy  ) + c[18 + 3].zwww );
    	oT3.x=temp.x;
    	oT3.y=temp.y;
}

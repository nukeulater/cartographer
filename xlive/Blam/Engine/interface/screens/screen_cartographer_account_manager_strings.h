...
const wchar_t *const k_screen_type_list_add_account_eng[] =
{
	L"Add account",
...
static const wchar_t *const k_screen_type_list_table_eng[] =
{
	L"Online Accounts",
...
static const wchar_t *const k_screen_type_list_create_account_eng[] =
{
	L"Create Account",

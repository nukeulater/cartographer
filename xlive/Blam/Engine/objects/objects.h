...
uint32 __cdecl object_search_for_objects_in_radius(int32 search_flags, e_object_type object_type, s_location* location, real_point3d* center, real32 radius, datum* out_object_indices, uint32 object_count);

...
e_rasterizer_target __cdecl rasterizer_get_sun_render_surface(
    real32 a1,
    real32 a2,
    real32 a3,
    e_rasterizer_target a4,
    e_rasterizer_target a5,
    int32 a6,
    int32 a7,
    int32 a8,
    int32 a9,
    ...
    real32 a11)
{
    return INVOKE(0x26C2CA, 0x0, rasterizer_get_sun_render_surface,
        a1,
        a2,
        a3,
        a4,

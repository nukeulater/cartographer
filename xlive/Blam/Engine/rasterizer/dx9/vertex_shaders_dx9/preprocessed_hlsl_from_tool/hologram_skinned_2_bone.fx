...
{
    float4 temp = (float4)(r12.wwww * c[5].wwww  );
    	r11.w=temp.w;
}
{
    float4 temp = (float4)((r12.xxxx * c[5].wwww  ) + r11.wwww );
    	oT0.x=temp.x;
}
{
    float4 temp = (float4)((-r12.yyyy * c[5].wwww  ) + r11.wwww );
    	oT0.y=temp.y;
}
{
...
{
    float4 temp = (float4)(_POSITION.xyzz + -c[7] .xyzz );
    	r1.x=temp.x;
    	r1.y=temp.y;
    	r1.z=temp.z;
}
{
    float4 temp = (float4)(dot(r1.xyz, c[4] .xyz));
    	r11.x=temp.x;
}
{
    float4 temp = (float4)(dot(r1.xyz, c[5] .xyz));
    	r11.y=temp.y;
}
...
{
    float4 temp = (float4)((r11.xyyy * c[18 + 1].xyyy ) + c[18 + 1].zwww );
    	oT2.x=temp.x;
    	oT2.y=temp.y;
}
{
    float4 temp = (float4)((r11.xyyy * c[18 + 2].xyyy ) + c[18 + 2].zwww );
    	oT3.x=temp.x;
    	oT3.y=temp.y;
}

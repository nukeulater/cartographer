...
{
	float temptemp;
	temptemp = dot(r1.xyz, c[18 + 0].xyz);
...
{
	float temptemp;
	temptemp = dot(r1.xyz, c[18 + 1].xyz);
...
{
	float temptemp;
	temptemp = dot(r2.xyz, c[18 + 2].xyz);
...
{
	float temptemp;
	temptemp = dot(r2.xyz, c[18 + 3].xyz);
...
{
	float temptemp;
	temptemp = dot(r3.xyz, c[18 + 4].xyz);
...
{
	float temptemp;
	temptemp = dot(r3.xyz, c[18 + 5].xyz);
...
{
	float temptemp;
	temptemp = dot(r4.xyz, c[18 + 6].xyz);
...
{
	float temptemp;
	temptemp = dot(r4.xyz, c[18 + 7].xyz);

...
{
    float4 temp = (float4)(dp3(c[6]  , _TANGENT ));
    	r10.x=temp.x;
}
{
    float4 temp = (float4)(dp3(c[6]  , _BINORMAL ));
    	r10.y=temp.y;
}
{
    float4 temp = (float4)(dp3(c[6]  , _NORMAL ));
    	r10.z=temp.z;
}
{
...
{
    float4 temp = (float4)(dp3(c[4]  , _NORMAL ));
    	r5.x=temp.x;
}
{
    float4 temp = (float4)(dp3(c[5]  , _NORMAL ));
    	r5.y=temp.y;
}
{
    float4 temp = (float4)(dp3(c[6]  , _NORMAL ));
...
{
    float4 temp = (float4)(r5 * r10.wwww );
    	r5.x=temp.x;
    	r5.y=temp.y;
    	r5.z=temp.z;
    	r5.w=temp.w;
...
{
    float4 temp = (float4)(dp3(r10 , _TANGENT ));
    	oT1.x=temp.x;
}
{
    float4 temp = (float4)(dp3(r10 , _BINORMAL ));
    	oT1.y=temp.y;
}
{
    float4 temp = (float4)((r10.wwww * r4.wwww ) + r5.xxxx );
    	oT1.z=temp.z;
}

{
    float4 temp = (float4)(dp3(r11 , _TANGENT ));
    	oT2.x=temp.x;
}
{
    float4 temp = (float4)(dp3(r11 , _BINORMAL ));
    	oT2.y=temp.y;
}
{
    float4 temp = (float4)((r11.wwww * r4.wwww ) + r5.yyyy );
    	oT2.z=temp.z;
}

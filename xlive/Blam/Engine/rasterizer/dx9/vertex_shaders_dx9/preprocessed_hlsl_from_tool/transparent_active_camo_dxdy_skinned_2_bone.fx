...
{
    float4 temp = (float4)(dot(c[4] .xyz, _TANGENT.xyz));
    	oT1.x=temp.x;
}
{
    float4 temp = (float4)(dot(c[4] .xyz, _BINORMAL.xyz));
    	oT1.y=temp.y;
}
{
...
{
    float4 temp = (float4)(dot(c[5] .xyz, _TANGENT.xyz));
    	oT2.x=temp.x;
}
{
    float4 temp = (float4)(dot(c[5] .xyz, _BINORMAL.xyz));
    	oT2.y=temp.y;
}
{

...
{
	float temptemp;
	temptemp = dot(r4.xyz, c[46].xyz);
 	temptemp = temptemp + c[46].wwww ;
 {
    float4 temp = (float4)(temptemp );
    	r11.x=temp.x;
}
...
{
	float temptemp;
	temptemp = dot(r4.xyz, c[47].xyz);
 	temptemp = temptemp + c[47].wwww ;
 {
    float4 temp = (float4)(temptemp );
    	r11.y=temp.y;
}
...
{
    float4 temp = (float4)(oT3.wwww * c[48].zwww );
    	r11.x=temp.x;
    	r11.y=temp.y;
}
{
    float4 temp = (float4)((oT3.xyyy * c[48].xyyy ) + r11.xyyy );
    	r11.x=temp.x;
    	r11.y=temp.y;
}
{
    float4 temp = (float4)(1.0f / (oT3.wwww ));
        r11.w=temp.w;
}
{
    float4 temp = (float4)(r11.zzzz * r11.wwww );
    	oT3.z=temp.z;
}
...
{
    float4 temp = (float4)((c[43] .yyww * oT3.wwww ) + r11.xyyy );
    	oT0.x=temp.x;
    	oT0.y=temp.y;
}
{
    float4 temp = (float4)((c[43] .xyww * oT3.wwww ) + r11.xyyy );
    	oT1.x=temp.x;
    	oT1.y=temp.y;
}
{
    float4 temp = (float4)((c[43] .yxww * oT3.wwww ) + r11.xyyy );
    	oT2.x=temp.x;
    	oT2.y=temp.y;
}

...
#define SH_COEFFICIENT0_R		c[18 + 3]
#define SH_COEFFICIENT0_G		c[18 + 4]
#define SH_COEFFICIENT0_B		c[18 + 5]
#define SH_COEFFICIENT1_R		c[18 + 6]
#define SH_COEFFICIENT1_G		c[18 + 7]
#define SH_COEFFICIENT1_B		c[18 + 10]
#define SH_COEFFICIENT2_RGB		c[18 + 11] 
...
{
    float4 temp = (float4)(dot(_NORMAL.xyzw, SH_COEFFICIENT0_R.xyzw));
    	r10.x=temp.x;
}
{
    float4 temp = (float4)(dot(_NORMAL.xyzw, SH_COEFFICIENT0_G.xyzw));
    	r10.y=temp.y;
}
{
    float4 temp = (float4)(dot(_NORMAL.xyzw, SH_COEFFICIENT0_B.xyzw));
    	r10.z=temp.z;
}

	r5 = _NORMAL.xyzz * _NORMAL.yzzx ;
 {
    float4 temp = (float4)(dot(r5.xyzw, SH_COEFFICIENT1_R.xyzw));
    	r11.x=temp.x;
}
{
    float4 temp = (float4)(dot(r5.xyzw, SH_COEFFICIENT1_G.xyzw));
    	r11.y=temp.y;
}
{
    float4 temp = (float4)(dot(r5.xyzw, SH_COEFFICIENT1_B.xyzw));
    	r11.z=temp.z;
}

{
    float4 temp = (float4)(_NORMAL.xyyy * _NORMAL.xyyy );
    	r4.x=temp.x;
    	r4.y=temp.y;
}
{
    float4 temp = (float4)(r4.xxxx - r4.yyyy );
    	r4.x=temp.x;
}

{
    float4 temp = (float4)((SH_COEFFICIENT2_RGB.xyzz * r4.xxxx ) + r10.xyzz );
    	r10.x=temp.x;
    	r10.y=temp.y;
    	r10.z=temp.z;
}
{
    float4 temp = (float4)(r10.xyzz + r11.xyzz );
    	oD0.x=temp.x;
    	oD0.y=temp.y;
    	oD0.z=temp.z;
}

...
{
    float4 temp = (float4)(dot(r10.xyz, c[50].xyz));
    	r0.x=temp.x;
}
{
    float4 temp = (float4)(r0.xxxx + c[50].wwww );
    	r0.x=temp.x;
}
{
    float4 temp = (float4)(dot(r10.xyz, c[51].xyz));
    	r0.y=temp.y;
}
{
    float4 temp = (float4)(r0.yyyy + c[51].wwww );
    	r0.y=temp.y;
}
{
    float4 temp = (float4)(dot(r10.xyz, c[52].xyz));
    	r0.z=temp.z;
}
{
    float4 temp = (float4)(r0.zzzz + c[52].wwww );
    	r0.z=temp.z;
}
...
{
    float4 temp = (float4)((r9 * c[18 + 3].xyyy  ) + c[18 + 3].zwww );
    	oT2.x=temp.x;
    	oT2.y=temp.y;
}
{
    float4 temp = (float4)((r9 * c[18 + 4].xyyy  ) + c[18 + 4].zwww );
    	oT3.x=temp.x;
    	oT3.y=temp.y;
}

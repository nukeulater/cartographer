...
{
	float temptemp;
	temptemp = dot(va_position.xyz, c[0].xyz);
...
{
	float temptemp;
	temptemp = dot(va_position.xyz, c[1].xyz);
...
{
	float temptemp;
	temptemp = dot(va_position.xyz, c[2].xyz);
...
{
	float temptemp;
	temptemp = dot(va_position.xyz, c[3].xyz);
...
{
	float temptemp;
	temptemp = dot(va_position.xyz, c[12].xyz);

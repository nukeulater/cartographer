...
{
	float temptemp;
	temptemp = dot(va_texcoord.xyz, c[18 + 0].xyz);
...
{
	float temptemp;
	temptemp = dot(va_texcoord.xyz, c[18 + 1].xyz);
...
{
	float temptemp;
	temptemp = dot(va_texcoord.xyz, c[18 + 2].xyz);
...
{
	float temptemp;
	temptemp = dot(va_texcoord.xyz, c[18 + 3].xyz);
...
{
	float temptemp;
	temptemp = dot(va_texcoord.xyz, c[18 + 4].xyz);
...
{
	float temptemp;
	temptemp = dot(va_texcoord.xyz, c[18 + 5].xyz);
...
{
	float temptemp;
	temptemp = dot(va_texcoord.xyz, c[18 + 6].xyz);
...
{
	float temptemp;
	temptemp = dot(va_texcoord.xyz, c[18 + 7].xyz);

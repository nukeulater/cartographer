...
bool __cdecl rasterizer_dx9_set_render_target_internal(IDirect3DSurface9* target, int32 z_stencil, bool a3)
{
	return INVOKE(0x26EBF8, 0x0, rasterizer_dx9_set_render_target_internal, target, z_stencil, a3);
}
